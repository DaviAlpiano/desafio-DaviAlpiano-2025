...
describe('Abrigo de Animais', () => {
  ...
  test('Deve rejeitar brinquedo inválido', () => {
    const resultado = new AbrigoAnimais().encontraPessoas('CAIXA,RATO', 'RATO,CARRO', 'Fofo');
  ...
  test('Loco é adotado sem se importar com a ordem', () => {
    const resultado = new AbrigoAnimais().encontraPessoas('BOLA,LASER',
      'RATO,CAIXA,NOVELO,SKATE', 'Mimi,Fofo,Rex,Bola,Loco');
  ...
  test('Loco não é adotado se estiver sozinho', () => {
    const resultado = new AbrigoAnimais().encontraPessoas('BOLA,LASER',
      'RATO,SKATE', 'Mimi,Fofo,Rex,Bola,Loco');
